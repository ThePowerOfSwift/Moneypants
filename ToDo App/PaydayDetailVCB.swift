...
class PaydayDetailVCB: UIViewController, UITableViewDataSource, UITableViewDelegate {
    
    @IBOutlet weak var tableView: UITableView!
    @IBOutlet weak var tableViewHeight: NSLayoutConstraint!
    let (userName, _, _) = tempUsers[homeIndex]
    let tempDailyHabitsSummary = [("daily habits:", 1500),
                                  ("habit consistency bonus:", 1500),
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            // PART 1
            let cell = tableView.dequeueReusableCell(withIdentifier: "CustomCell1", for: indexPath) as! PaydayDetailCellB1
            let (habitDescription, day1, day2, day3, day4, day5, day6, day7, _) = tempPaydayDailyHabits[indexPath.row]
            ...
            cell.habitDesc.text = habitDescription
            ...
            // PART 2
            let cell2 = tableView.dequeueReusableCell(withIdentifier: "CustomCell2", for: indexPath) as! PaydayDetailCellB2
            let (_, pointAmount) = tempDailyHabitsSummary[indexPath.row]
    ...
    @IBAction func questionButtonTapped(_ sender: UIButton) {
        ...
        let messageText = NSMutableAttributedString(
            string: "What do the colors and numbers mean?\n\n\tGreen: completed\n\tGray: not completed\n\nHabits will have a number if they are completed more than once per day.",
            attributes: [
