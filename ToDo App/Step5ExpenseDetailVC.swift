...
class Step5ExpenseDetailVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        datePicker.addTarget(self, action: #selector(Step5ExpenseDetailVC.datePickerValueChanged(sender:)), for: UIControlEvents.valueChanged)
