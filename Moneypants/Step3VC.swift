...
class Step3VC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var jobCountMin = MPUser.usersArray.count           // there must be at least one daily job and one weekly job per user
    let jobCountMax = 20
...
//            print("segue initiated")
    ...
    func changeJobOrderOnFirebase(dailyOrWeekly: String, jobName: String, newJobOrder: Int, completion: @escaping (DataSnapshot) -> ()) {
