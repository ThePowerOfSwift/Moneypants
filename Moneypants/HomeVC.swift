...
//                              Points(user: "Father", itemName: "good language", itemCategory: "daily habits", code: "C", valuePerTap: 24, itemDate: 1511333997.9687519),
...
//                              Points(user: "Father", itemName: "good language", itemCategory: "daily habits", code: "C", valuePerTap: 24, itemDate: 1511561491.9467549),
...
//                              Points(user: "Father", itemName: "good language", itemCategory: "daily habits", code: "C", valuePerTap: 24, itemDate: 1511475101.8270481),
...
//                              Points(user: "Father", itemName: "good language", itemCategory: "daily habits", code: "C", valuePerTap: 24, itemDate: 1511388711.171706),
...
//                              Points(user: "Father", itemName: "good language", itemCategory: "daily habits", code: "C", valuePerTap: 24, itemDate: 1511302319.7712111),
...
//        Income.currentIncomeArray = [Moneypants.Income(user: "Father", currentPoints: -17), Moneypants.Income(user: "Mother", currentPoints: 125), Moneypants.Income(user: "Allan", currentPoints: 0), Moneypants.Income(user: "Sophie", currentPoints: 0), Moneypants.Income(user: "Savannah", currentPoints: 0), Moneypants.Income(user: "Flower", currentPoints: 0)]
        ...
        // testing payday
        Points.pointsArray = [Moneypants.Points(user: "Father", itemName: "on time to events", itemCategory: "daily habits", code: "C", valuePerTap: 6, itemDate: 1511561495.627692), Moneypants.Points(user: "Father", itemName: "read (20 min)", itemCategory: "daily habits", code: "C", valuePerTap: 6, itemDate: 1511561495.9800229), Moneypants.Points(user: "Father", itemName: "good deed / service", itemCategory: "daily habits", code: "C", valuePerTap: 6, itemDate: 1511475105.146647), Moneypants.Points(user: "Father", itemName: "family prayer & scriptures", itemCategory: "daily habits", code: "C", valuePerTap: 6, itemDate: 1511475105.4754581), Moneypants.Points(user: "Father", itemName: "1-on-1 time with kid", itemCategory: "daily habits", code: "C", valuePerTap: 6, itemDate: 1511388712.7825761), Moneypants.Points(user: "Father", itemName: "practice talent (30 min)", itemCategory: "daily habits", code: "C", valuePerTap: 6, itemDate: 1511388713.1786749), Moneypants.Points(user: "Father", itemName: "exercise (20 min)", itemCategory: "daily habits", code: "C", valuePerTap: 6, itemDate: 1511302321.6023149), Moneypants.Points(user: "Father", itemName: "journal", itemCategory: "daily habits", code: "C", valuePerTap: 6, itemDate: 1511302322.0879591), Moneypants.Points(user: "Father", itemName: "habit bonus", itemCategory: "daily habits", code: "B", valuePerTap: 0, itemDate: 1512020613.8978961), Moneypants.Points(user: "Father", itemName: "habit bonus", itemCategory: "daily habits", code: "B", valuePerTap: 0, itemDate: 1511675133.577493), Moneypants.Points(user: "Father", itemName: "good language", itemCategory: "daily habits", code: "C", valuePerTap: 24, itemDate: 1511243024.3690319), Moneypants.Points(user: "Father", itemName: "pray & scripture study", itemCategory: "daily habits", code: "C", valuePerTap: 6, itemDate: 1511243026.2214751), Moneypants.Points(user: "Father", itemName: "good language", itemCategory: "daily habits", code: "N", valuePerTap: 0, itemDate: 1511675133.577493), Moneypants.Points(user: "Father", itemName: "pray & scripture study", itemCategory: "daily habits", code: "N", valuePerTap: 0, itemDate: 1511675133.577493)]
        
        Income.currentIncomeArray = [Moneypants.Income(user: "Father", currentPoints: 78), Moneypants.Income(user: "Mother", currentPoints: 0), Moneypants.Income(user: "Allan", currentPoints: 0), Moneypants.Income(user: "Sophie", currentPoints: 0), Moneypants.Income(user: "Savannah", currentPoints: 0), Moneypants.Income(user: "Flower", currentPoints: 0)]
